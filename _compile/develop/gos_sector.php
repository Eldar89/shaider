...
<?php /*
 Template Name: Государственный сектор
*/?><!DOCTYPE html>
<html lang="RU-ru">
  <head>
    <meta charset="utf-8">
  ...
  <body><a name="topSite"></a>
    ...
    <sections id="gos_sector" class="header_subPage">
    ...
    <section class="another_page">
      <div class="container-own">
        <div class="wrap_another"><a href="http://тест.kz/shaider/building/" class="another_block"><img src="<?php echo get_template_directory_uri();?>/images/3_services.jpg">
            <h3>Промышленное и гражданское строительство</h3></a><a href="http://тест.kz/shaider/nedrouser/" class="another_block"><img src="<?php echo get_template_directory_uri();?>/images/1_services.jpg">
            <h3>Недропользователь</h3></a><a href="http://тест.kz/shaider/agro/" class="another_block"><img src="<?php echo get_template_directory_uri();?>/images/4_services.jpg">
    ...
    <?php 
     $part = array(
       ...
       'category_name' => 'ready_object_goverment' //Категория постов
     );
    ?>
